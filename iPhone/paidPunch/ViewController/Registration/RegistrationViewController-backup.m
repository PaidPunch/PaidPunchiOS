...
-(void) populateFields
{
    ...
    username=cell.valueTextField.text;
    ...
    email=cell.valueTextField.text; 
    ...
    confirmPassword=cell.valueTextField.text;
	...
	password=cell.valueTextField.text;
    ...
    mobileNumber=cell.valueTextField.text;
    ...
    zipcode=cell.valueTextField.text;*/
...
-(Registration *)populate
{
    ...
    [registrationDetails setValue:username forKey:@"username"];
    [registrationDetails setValue:password forKey:@"password"];
    [registrationDetails setValue:confirmPassword forKey:@"confirm_password"];
    [registrationDetails setValue:email forKey:@"email"];
    [registrationDetails setValue:mobileNumber forKey:@"mobile"];
    [registrationDetails setValue:zipcode forKey:@"zipcode"];
