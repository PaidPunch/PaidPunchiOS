...
- (void) searchBarSearchButtonClicked:(UISearchBar *)theSearchBar {
    ...
    [[InfoExpert sharedInstance] setSearchType:SEARCH_BY_NAME];
    NSNumber *sMiles=[NSNumber numberWithDouble:[totalMilesTxtField.text doubleValue]];
...
-(void) goToSearchListView:(NSString *)searchType withCategory:(NSString *)category withTotalMiles:(NSNumber *)sMiles
{
    ...
    [totalMilesTxtField resignFirstResponder];
    SearchListViewController *searchListViewController= [[SearchListViewController alloc] init:searchType withCategory:category withTotalMiles:sMiles withCurrentlocation:self.currentLocation withBusinessName:self.searchBar.text withCityOrZipCode:cityTxtField.text];
    [self.navigationController pushViewController:searchListViewController animated:NO];
