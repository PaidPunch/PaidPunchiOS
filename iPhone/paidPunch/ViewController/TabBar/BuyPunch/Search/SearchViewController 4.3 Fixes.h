...
@interface SearchViewController : UIViewController <UITableViewDelegate, UITableViewDataSource, UITextFieldDelegate, UIAlertViewDelegate, NetworkManagerDelegate, CLLocationManagerDelegate, EGORefreshTableHeaderDelegate, MKReverseGeocoderDelegate>
{
