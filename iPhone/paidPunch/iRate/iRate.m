...
- (iRate *)init
{
    if ((self = [super init]))
    {
        ...
        usesUntilPrompt = 4;
        eventsUntilPrompt = 8;
        daysUntilPrompt = 4.0f;
        remindPeriod = 1.0f;
        
        //message text, you may wish to customise these, e.g. for localisation
        self.messageTitle = @"We want to hear from you!"; //set lazily so that appname can be included
        self.message = @"Do you love PaidPunch? Please take a few seconds out of your day to let us know how we're doing and rate PaidPunch in the App Store!"; //set lazily so that appname can be included
